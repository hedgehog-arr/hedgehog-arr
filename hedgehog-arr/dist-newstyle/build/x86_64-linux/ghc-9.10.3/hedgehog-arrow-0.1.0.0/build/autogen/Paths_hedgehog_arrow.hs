...
-- at runtime using the environment variable hedgehog_arrow_bindir.
...
-- environment variable hedgehog_arrow_libdir.
...
-- using the environment variable hedgehog_arrow_dynlibdir.
...
-- runtime using the environment variable hedgehog_arrow_datadir.
...
-- variable hedgehog_arrow_libexedir.
...
-- using the environment variable hedgehog_arrow_sysconfdir.
...
bindir     = "/home/vandikas/.cabal/bin"
libdir     = "/home/vandikas/.cabal/lib/x86_64-linux-ghc-9.10.3-df3b/hedgehog-arrow-0.1.0.0-inplace"
dynlibdir  = "/home/vandikas/.cabal/lib/x86_64-linux-ghc-9.10.3-df3b"
datadir    = "/home/vandikas/.cabal/share/x86_64-linux-ghc-9.10.3-df3b/hedgehog-arrow-0.1.0.0"
libexecdir = "/home/vandikas/.cabal/libexec/x86_64-linux-ghc-9.10.3-df3b/hedgehog-arrow-0.1.0.0"
sysconfdir = "/home/vandikas/.cabal/etc"

getBinDir     = catchIO (getEnv "hedgehog_arrow_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "hedgehog_arrow_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "hedgehog_arrow_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "hedgehog_arrow_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "hedgehog_arrow_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "hedgehog_arrow_sysconfdir") (\_ -> return sysconfdir)
